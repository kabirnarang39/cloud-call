...
const emojiPicker=()=>{
  ...
  document.querySelector('.main_message_container_chat').style.zIndex='10000000';
  document.querySelector('.main_message_container_chat').style.margin='20px';
  document.querySelector('.main_message_container_chat').style.overflow='scroll';
  document.querySelector('.main_message_container_chat').style.position='relative';
